...
@onready var _sprite         : Sprite2D  = $DetailView/Sprite2D
...
func _refresh_power_indicator() -> void:
	if not powered:
		return
	var col := _get_pattern_color()
	power_indicator.modulate = col
...
func _load_sprite() -> void:
	...
	var path        : String = dir + "/" + script_name + ".png"
